        ...
        <form class="form-horizontal" role="form" method="post" action="<?php echo base_url();?>product/lampu/save" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <input name="derajat" class="form-control" type="number" step="any" required>
                </div>(deg)
              </div>
              <div class="form-group">
                <label class="col-lg-2 control-label">Wattage</label>
                <div class="col-lg-8">
                  <input name="daya" class="form-control" type="number" step="any" required> 
                </div>(W)
              </div>
               <div class="form-group">
           ...
           <div class="col-lg-6">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-lg-8">
                  <input name="tegangan" class="form-control" type="number" step="any" required> 
                </div>(V)
              </div>
               <div class="form-group">
                <label class="col-lg-2 control-label">Life<span style="color:#fff">_</span>time</label>
                <div class="col-lg-8">
                  <input name="umur" class="form-control" type="number" step="any" required> 
                </div>(Hours)
              </div>
              <div class="form-group">
